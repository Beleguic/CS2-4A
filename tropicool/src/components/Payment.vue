    ...
    <div class="flex flex-col items-center gap-4 min-h-screen">
      <div class="w-8/12">
        ...
        <p class="flex flex-row justify-between">
          <span>Vous n'etes pas connecter ?</span>
          <RouterLink to="/login">Se conncter</RouterLink>
        </p>
        <FormComponent
          :fields="fields"
...
const fields = [
  {
    ...
    fields: [
      [
        { name: 'nom', label: 'Nom', type: 'text', required: true, labelColor: 'black' },
        { name: 'prenom', label: 'Prénom', type: 'text', required: true, labelColor: 'black' }
      ],
      ...
      [
        ...
        { name: 'code_postale', label: 'Code postal', type: 'number', required: true, labelColor: 'black' }
      ],
  ...
  },
  {
    ...
    fields: [
      ...
      [
        { name: 'ville', label: 'Ville', type: 'text', required: true },
        { name: 'code_postale', label: 'Code postal', type: 'number', required: true, widthInput: '40%', labelColor: 'black' }
      ],
      [{ name: 'telephone', label: 'Téléphone', type: 'tel', required: true, labelColor: 'black' }]
    ]
  }
...
const login = async (formData: { email: string; password: string }) => {
  try {
    // Remplacer par la logique de connexion réelle
