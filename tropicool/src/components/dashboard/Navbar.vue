<template>
    <header class="top-0 left-0 sticky w-full flex justify-between py-4 px-6 border-b border-b-gray-200 items-center bg-white">
        <div class="max-w-3xl w-full">
            <form action="" method="get" class="flex">
                <input 
                    ...
                    required
                    placeholder="Search ..."
                    class="text-black w-full border border-gray-200 border-r-0 px-4 py-2">
                <button 
                    type="submit"
        ...
        <div class="relative">
            <button 
                @click="toggleMenu"
                class="group bg-main hover:bg-secondary rounded-md flex items-center gap-4 px-4 py-2">
                <div>
