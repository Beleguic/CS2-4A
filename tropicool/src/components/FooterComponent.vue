<template>
  <footer id="main-footer" class="bg-[#696BE2] text-white p-6 flex flex-col items-center justify-center w-full">
    ...
    <img src="/Bandeau-Boissons-Alcooliques.jpg" alt="Bandeau Boissons Alcooliques" class="footer-banner mt-4" />
  </footer>
</template>
